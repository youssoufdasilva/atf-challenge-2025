  ...
  return (
    <section id="logos">
      <div className="container mx-auto px-4 md:px-8 py-12">
        ...
        <div className="relative mt-6">
          {/* <div className="relative flex h-[500px]= mt-6 w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl"> */}
          <Marquee pauseOnHover className="[--duration:120s]">
            {first_universities.map((name, idx) => (
              <BlurIn
                key={`${idx}-first-uni`}
                word={name}
                className="text-lg font-bold text-black dark:text-white border-r-8 px-8 -ml-5 border-black"
              />
            ))}
          </Marquee>
